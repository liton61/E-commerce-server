...
// mongodb+srv://<username>:<password>@cluster0.hgznyse.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
...
async function run() {
  try {
    ...
    const usersCollection = client.db("E-shopDB").collection("users");
    const productCollection = client.db("E-shopDB").collection("products");
